...
CREATE TABLE IF NOT EXISTS `MER_optica`.`DETALLES_VENTA` (
  ...
  `venta` INT(10) UNSIGNED NOT NULL,
  `producto` INT(10) UNSIGNED NULL DEFAULT NULL,
  `formula` INT(10) UNSIGNED NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `MER_optica`.`PERSONA` (
  ...
  `tipo_documento` ENUM('Cedula De Ciudadania','Tarjeta De Identidad','Registro Civil','Pasaporte','Cedula De Extrangeria') NOT NULL,
