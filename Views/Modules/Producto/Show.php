                                ...
                                if (!empty($DataProducto)) {
                                    ...
                                    <div class="card-header">
                                        <h3 class="card-title"><i class="fas fa-shopping-cart"></i> &nbsp; Ver
                                            Información de <?= $DataProducto->getNombre() ?>
                                            -<?= $DataProducto->getIdProducto() ?></h3>
                                    ...
                                    <div class="card-body">
                                        <p>
                                            ...
                                            <strong><i class="fas fa-sort-numeric-down mr-1"></i> Nombre</strong>
                                        <p class="text-muted">
                                            <?= $DataProducto->getNombre() . "-" . $DataProducto->getIdProducto(); ?>
                                        </p>
                                        <hr>
                                        <strong><i class="fas fa-user-ninja mr-1"></i> Categoria</strong>
                                        <p class="text-muted"><?= $DataProducto->getIdCategoria()->getNombre() ?></p>
                                        <hr>
                                        <strong><i class="far fa-user mr-1"></i> Marca</strong>
                                        <p class="text-muted"><?= $DataProducto->getIdMarca()->getNombre() ?></p>
                                        <hr>
                                        <strong><i class="far fa-calendar mr-1"></i> Descripcion</strong>
                                        <p class="text-muted"><?= $DataProducto->getDescripcion(); ?></p>
                                        <hr>
                                        <strong><i class="fas fa-money-bill mr-1"></i> Iva</strong>
                                        <p class="text-muted"><?= $DataProducto->getIva(); ?></p>
                                        <hr>
                                        <strong><i class="fas fa-money-bill mr-1"></i> Stock</strong>
